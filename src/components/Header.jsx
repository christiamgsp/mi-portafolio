...
const Header = () => {
  ...
  const emailBody = encodeURIComponent(
    'Hola Christiam,\n\nHe visto tu portfolio y me ha interesado mucho tu perfil técnico, especialmente tu experiencia en React y tu background en IT Support. Me gustaría que pudiéramos agendar una breve llamada para conocerte mejor.\n\nSaludos.'
  );
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start gap-16'>
          <div className='flex-1 space-y-8 text-center md:text-left order-2 md:order-1'>
            ...
            <p className='text-[15px] text-slate-400 leading-relaxed max-w-xl mx-auto md:mx-0'>
              ...
              analítica, optimizando el rendimiento y garantizando soluciones
              escalables bajo estándares de calidad premium.
            </p>
