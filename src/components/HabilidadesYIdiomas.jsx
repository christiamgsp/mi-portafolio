  ...
  return (
    <section className='py-8 md:py-12 bg-[#0A0A0A]'>
      <div className='container mx-auto px-6 max-w-5xl'>
        <div className='bg-[#141414] p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-[#262626] shadow-2xl'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12'>
            {/* Technical Stack */}
            <div className='space-y-6 md:space-y-8'>
              <h2 className='text-xl md:text-2xl font-black text-white tracking-tighter uppercase border-l-4 border-[#00E6FF] pl-4'>
                Technical Stack
              </h2>
                ...
                {technicalSkills.map((skill) => (
                  <div key={skill.name} className='group space-y-2'>
                    <div className='flex justify-between items-end'>
                      <p className='text-xs md:text-sm text-white font-bold group-hover:text-[#00E6FF] transition-colors'>
                        {skill.name}
                      </p>
            ...
            <div className='space-y-8 md:space-y-10'>
              <div className='space-y-4'>
                <h2 className='text-xl md:text-2xl font-black text-white tracking-tighter uppercase border-l-4 border-[#262626] pl-4'>
                  Communication
                </h2>
                <div className='flex flex-col sm:flex-row gap-4'>
                  <div className='bg-[#0A0A0A] border border-[#262626] p-4 md:p-5 rounded-2xl flex-1'>
                    <p className='text-sm text-white font-bold'>English</p>
                    <p className='text-[10px] text-[#00E6FF] font-black uppercase tracking-wider'>
                      C1 Advanced
                    </p>
                  </div>
                  <div className='bg-[#0A0A0A] border border-[#262626] p-4 md:p-5 rounded-2xl flex-1'>
                    <p className='text-sm text-white font-bold'>Spanish</p>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex flex-wrap gap-2'>
                  {[
                    ...
                    <span
                      key={s}
                      className='text-[9px] md:text-[10px] font-black bg-[#0A0A0A] text-slate-400 border border-[#262626] px-3 py-1.5 rounded-lg uppercase'>
                      {s}
                    </span>
                  ))}
                </div>
